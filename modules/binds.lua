...
---------------- {{{ My (custom) key binds }}} ----------------
    ...
    awful.key({ modkey, "Mod1" }, "r", function () awful.util.spawn("obs") end,
            {description = "| запустить NVtop (системный монитор Nvidia)", group = "Programs/scripts"}),
    awful.key({ modkey, "Shift" }, "r", function () awful.util.spawn("/home/izunamori/.config/awesome/scripts/functional/redshift.sh") end,
        {description = "| переключить redshift", group = "Programs/scripts"}),
