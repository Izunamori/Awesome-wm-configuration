...
---------------- {{{ My (custom) key binds }}} ----------------
    ...
    awful.key({ modkey, "Shift" }, "v", function () awful.util.spawn("/home/izunamori/.config/awesome/scripts/functional/vpn.sh") end,
        {description = "| переключить VPN", group = "Programs/scripts"}),
