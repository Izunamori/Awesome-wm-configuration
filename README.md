...
## Мои пакеты
```bash
sudo pacman -Syyu thunar steam tumbler ffmpegthumbs mpv fish ttf-jetbrains-mono ntfs-3g pavucontrol lib32-nvidia-utils gvfs nwg-look qt6ct kvantum polkit-gnome xcolor pipewire pipewire-pulse file-roller zip unzip btop flatpak obs-studio jp2a discord vscode telegram-desktop gparted telegram-desktop gparted thunar-archive-plugin polkit-gnome xclip --noconfirm
